...
let deleteCategory = () => {
  loading.value = true;
  isDeleteModal.value = false;
  router.delete(route('categories.destroy', editForm.id), {
    preserveState: true,
    preserveScroll: true,
    onSuccess: () => {
...
<template>
  <Head :title="__('main.category-list')"/>
          ...
          <div v-if="categories">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                ...
                <td class="px-2 py-2" >
                  <div class="flex items-center">
                  <ion-icon v-if="category.icon" :name="category.icon" class="size-6"></ion-icon>
                  </div>
                </td>
                <td class="px-2 py-2">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div class="mt-2">
                      <strong>You Are Sure ? You Want to Delete This Category
