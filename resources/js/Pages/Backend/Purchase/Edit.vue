...
usePurchaseStore().setAllPurchases(props.purchase.purchase_products)
usePurchaseStore().setAllWithdraws(props.purchase.withdraws)
onBeforeMount(() => updatePayment())
onBeforeMount(() => productAll())
onUnmounted(() => {
...
const form = useForm({
    ...
    'withdraws': computed(() => usePurchaseStore().allWithdraws)
});
...
const paymentTotal = () => {
    let payment = 0;
    usePurchaseStore().allWithdraws.forEach(withdraw => {
                ...
                <div class="shadow-md sm:rounded-lg mt-5">
                    ...
                    <div class="max-w-8xl">
                        ...
                        <table
                            ...
                            <tr class="space-x-2 space-y-2 border  divide-x-2"
                                v-for="withdraw in usePurchaseStore().allWithdraws">
                                ...
                                <th scope="col" class=" text-center" style="width: 10%;"><input @change="updatePayment"
                                                                                                id="receive"
                                                                                                type="number"
                                                                                                class="w-full m-0 py-1 px-2 bg-slate-50 rounded-md"
                                                                                                v-model="withdraw.receive">
                                </th>
                                <th scope="col" class="" style="width: 10%;"><input @change="updatePayment" id="return"
                                                                                    type="number"
                                                                                    class="w-full m-0 py-1 px-2 bg-slate-50 rounded-md"
                                                                                    v-model="withdraw.return"></th>
                                <th scope="col" class=" text-right" style="width: 20%;">
                                    <v-select class="" v-model="withdraw.account_id"
                                              :reduce="account => account.id" label="name"
                                              :options="accounts" placeholder="Select Account">

                                    </v-select>
                                </th>
                                <th scope="col" class="" style="width: 10%;"><input @change="updatePayment"
                                                                                    type="number"
                                                                                    class="w-full m-0 py-1 px-2 bg-slate-50 rounded-md"
                                                                                    v-model="withdraw.amount"></th>
                                <th scope="col" class="p-2 text-right" style="width: 10%;">Payment</th>
                                <th scope="col" class="p-2 text-right" style="width: 5%;">{{ withdraw.amount }}</th>
                            </tr>
                            <tr class="space-x-2 space-y-2 border  divide-x-2">
                                    ...
                                    <div class="">
                                        <table
                                            ...
                                            <tr class="border divide-x-2"
                                                ...
                                                <td scope="col" class="p-2" style="width: 15%;">
                                                    <v-select class="style-chooser1" v-model="stock.color_id"
