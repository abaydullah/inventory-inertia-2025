...
function openUpdateModal(supplier) {
  ...
  editForm.photo_url = supplier.photo_url;
  editForm.proprietor_name = supplier.proprietor_name;
  editForm.mobile = supplier.mobile;
  editForm.address = supplier.address;
  editForm.due = supplier.due;
  editForm.email = supplier.email;
  editForm.group_id = supplier.group_id;
...
let updateSupplier = () => {
  loading.value = true;
  editForm.post(route('suppliers.update', editForm.id), {
    preserveScroll: true,
    onSuccess: () => {
      isOpenUpdateModal.value = false;
      loading.value = false;
...
let deleteSupplier = () => {
  loading.value = true;
  isDeleteModal.value = false;
  router.delete(route('suppliers.destroy', editForm.id), {
    preserveState: true,
    preserveScroll: true,
    onSuccess: () => {
...
<template>
  <Head :title="__('main.supplier-list')"/>
  ...
  <AuthenticatedLayout>
    ...
    <div class="py-10 max-w-7xl mx-auto">
      ...
      <div id="content" class="">
        ...
        <Header title="main.supplier-list"></Header>
          ...
          <div v-if="suppliers">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                  v-for="(supplier,index) in suppliers.data" :key="index">
                <td class="w-4 p-2">
                  <div class="flex items-center">
                    {{ index + 1 }}
                ...
                <th scope="row" class="p-2">
                  <div class="flex items-center">
                    <img :src="supplier.photo_url" alt="" width="60">
                ...
                <th scope="row" class="p-2">
                  <div class="flex items-center">
                    {{ supplier.proprietor_name }}

                  </div>
                </th>
                <td class="px-2 py-2"> <div v-for="group in supplier.group_id">
                  <span class="capitalize">{{ group.name }}</span>

                </div>
                </td>
                <td class="px-2 py-2">
                  <span class="capitalize">{{ supplier.email }}</span><br>
                  <span class="capitalize">{{ supplier.mobile }}</span>
                </td>
                <td class="px-2 py-2">{{ supplier.due }}
                </td>

                <td class="px-2 py-2 space-x-3">
                  <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                     v-on:click="openUpdateModal(supplier)">
                    <ion-icon name="create"
                              class="pt-2 " size="large"></ion-icon>
                  </a>
                  <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                     v-on:click="openDeleteModal(supplier)">
            ...
            <Pagination :meta="suppliers.meta"></Pagination>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <div class="mt-2 flex space-x-6 justify-between w-full">
                      <img :src="imagePreview? imagePreview : form.photo_url" alt="No Image" width="40" height="40"
                           class="max-w-3/12 h-20 w-20">
                      <input type="file" class="form-input px-4 py-3 rounded-md sr-only"
                             id="image" placeholder="Enter Your Supplier Name"
                      ...
                      <button
                          ...
                          v-if="photo" v-on:click="photo = null" type="button">Clear
                      </button>
                      <label for="image"
                             class="text-lg font-semibold w-9/12 h-20 text-indigo-600 border-gray-200 border-2 flex items-center justify-center"
                    ...
                    <div class="mt-2">
                      <label for="name" class="text-lg font-semibold">Company Name</label>
                      <input type="text" class="form-input px-4 py-3 rounded-md w-full my-2"
                             id="name" v-model="form.company_name"
                             placeholder="Enter Your Supplier Company Name">
                      <span class="text-lg text-red-600 font-semibold"
                            v-if="form.errors.company_name">{{ form.errors.company_name }}</span>
                    </div>
                    <div class="mt-2">
                      <label for="name" class="text-lg font-semibold">Proprietor Name</label>
                      <input type="text" class="form-input px-4 py-3 rounded-md w-full my-2"
                             id="name" v-model="form.proprietor_name"
                             placeholder="Enter Your Supplier Proprietor Name">
                      <span class="text-lg text-red-600 font-semibold"
                            v-if="form.errors.proprietor_name">{{ form.errors.proprietor_name }}</span>
                    </div>
                    ...
                    <div class="mt-2">
                      ...
                      <input type="number" class="form-input px-4 py-3 rounded-md w-full mt-2"
                             ...
                             placeholder="Enter Your Supplier Due">
                    ...
                    <div class="mt-2">
                      ...
                      <textarea type="text" class="form-input px-4 py-3 rounded-md w-full mt-2"
                                ...
                                placeholder="Enter Your Supplier About"> </textarea>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div class="mt-2 flex space-x-6 justify-between w-full">
                      <img :src="editImagePreview? editImagePreview : editForm.photo_url" alt="No Image" width="40"
                    ...
                    <div class="mt-2">
                      <label for="name" class="text-lg font-semibold">Company Name</label>
                      <input type="text" class="form-input px-4 py-3 rounded-md w-full my-2"
                             id="name" v-model="editForm.company_name"
                             placeholder="Enter Your Supplier Company Name">
                      <span class="text-lg text-red-600 font-semibold"
                            v-if="editForm.errors.company_name">{{ editForm.errors.company_name }}</span>
                    </div>
                    <div class="mt-2">
                      <label for="name" class="text-lg font-semibold">Proprietor Name</label>
                      <input type="text" class="form-input px-4 py-3 rounded-md w-full my-2"
                             id="name" v-model="editForm.proprietor_name"
                             placeholder="Enter Your Supplier Proprietor Name">
                      <span class="text-lg text-red-600 font-semibold"
                            v-if="editForm.errors.proprietor_name">{{ editForm.errors.proprietor_name }}</span>
                    </div>
                    ...
                    <div class="mt-2">
                      ...
                      <input type="text" class="form-input px-4 py-3 rounded-md w-full mt-2"
                             ...
                             placeholder="Enter Your Mobile Number">
                      <span class="text-lg text-red-600 font-semibold" v-if="editForm.errors.mobile">{{
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div class="mt-2">
                      <strong>You Are Sure ? You Want to Delete This Supplier
